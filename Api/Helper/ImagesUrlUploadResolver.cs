...
{
    public class ImagesUrlUploadResolver
    {
        public async Task<string> UploadImage(IFormFile imageFile)
        {
            ...
            var uploadDirectory = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "images", "uploadimages");
            ...
            var imageUrl = "images/uploadimages/" + uniqueFileName;
            return imageUrl;
        }
